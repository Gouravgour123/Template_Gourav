...
export class SettingsService {
  ...
  // Function to upsert user setting
  ...
  // Function to upsert system setting
  ...
  // Function to map selections to options
